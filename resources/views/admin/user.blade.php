            ...
            <main class="content px-3 py-4">
                <div class="container-fluid">
                    <div class="mb-3">
                        ...
                        <div class="mb-3">
                            <button class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modalTambah"><i class='bx bx-user-plus'></i> Tambah User</button>
                                        ...
                                        <tr class="text-center">
                                            ...
                                            <td class="table-actions">
                                                <form action="{{ route('user.destroy', $user->ni) }}" method="POST" style="display:inline">
                                                    <a href="#" class="btn btn-warning" style="border-radius: 10px;" data-bs-toggle="modal" data-bs-target="#showModal{{$user->ni}}">
                                                        <i class="fas fa-eye fa-sm"></i> Show
                                                    </a>
                                                    <a href="#" class="btn btn-primary" style="border-radius: 10px;" data-bs-toggle="modal" data-bs-target="#editModal{{$user->ni}}">
                        ...
                        <!-- Modal Edit -->
                        @foreach($users as $user)
                        <div class="modal fade modal-lg" id="editModal{{$user->ni}}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    <div class="modal-header">
